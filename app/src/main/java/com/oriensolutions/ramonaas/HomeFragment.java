...
import com.oriensolutions.ramonaas.adapter.ItemAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ItemAdapter itemAdapter = new ItemAdapter(items, HomeFragment.this.getActivity());
                ...
                for (DocumentChange change : value.getDocumentChanges()) {
                    ...
                    switch (change.getType()) {
                        ...
                        case MODIFIED:
                            ...
                            if (old != null) {
                                old.setDescription(Integer.toString(item.getQty()));
